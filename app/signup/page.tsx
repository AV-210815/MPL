    ...
    <div className="min-h-screen bg-[#0d0d1a] px-4 py-12 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-2xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 text-sm">Select your apartment league to create an account</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {apartments.map((apt, idx) => {
              ...
              return (
                <Link key={apt.id} href={`/${apt.slug}/signup`}
                  ...
                  <div className="mt-auto">
                    <span className="text-[10px] px-2 py-0.5 rounded-full bg-white/10 text-gray-400 font-semibold">Sign up here →</span>
                  </div>
                </Link>
              );
            })}
        ...
        <div className="mt-8 text-center space-y-3">
          <Link href="/apartments"
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-dashed border-indigo-500/40 hover:border-indigo-500/70 bg-indigo-500/5 hover:bg-indigo-500/10 transition-all text-sm text-indigo-400 hover:text-indigo-300 font-medium">
