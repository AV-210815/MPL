...
export default async function OrangeCapPage({ searchParams }: { searchParams: Promise<{ format?: string }> }) {
  const { format } = await searchParams;
  const rows = await getBattingLeaderboard(format);
