...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const u = (form.elements.namedItem("username") as HTMLInputElement)?.value?.trim() || username.trim();
  ...
  return (
    <div className="min-h-screen bg-[#0d0d1a] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] rounded-full bg-blue-600/6 blur-[100px]" />
        {/* Grid */}
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 space-y-5 shadow-[0_0_60px_rgba(0,0,0,0.5)]">
          <div className="space-y-1 text-center">
            <h2 className="text-xl font-black text-white" style={{ fontFamily: "var(--font-rajdhani)" }}>
              Welcome back
            </h2>
            <p className="text-gray-600 text-xs">Sign in to your league account</p>
          </div>
          ...
          <p className="text-center text-xs text-gray-600">
            ...
            <Link href="/signup" className="text-orange-400 hover:text-orange-300 font-semibold transition-colors">Sign up</Link>
          </p>
